        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="max-w-5xl">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              ...
              <Link
                href="/airdrop"
                className="rounded-xl border border-cyan-500/30 bg-cyan-500/5 px-7 py-4 font-semibold text-cyan-400 transition hover:border-cyan-400 hover:bg-cyan-400 hover:text-black"
              >
                Airdrop
              </Link>
              ...
              <Link
                href="/nft"
                className="rounded-xl border border-purple-500/30 bg-purple-500/5 px-7 py-4 font-semibold text-purple-300 transition hover:border-purple-400 hover:bg-purple-400 hover:text-black"
              >
                Sad Monkey NFT
              </Link>
